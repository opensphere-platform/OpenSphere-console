...
var commandDefinitions = []commandDefinition{
	...
	{Name: "observability", Summary: "HISS 상태·target·PromQL 조회", Usage: []string{"os observability status|targets", "os observability query --expr PROMQL"}, Options: []string{"--expr PROMQL"}},
