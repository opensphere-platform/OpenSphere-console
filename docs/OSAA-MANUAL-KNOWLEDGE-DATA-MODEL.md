...
| Read/plan HIS Observability configuration | `osaa.his.observability.config` / `osaa.his.observability.plan` | `cluster-manager-his-owner-facade` | `read` | `none` |
| Apply HIS Observability configuration | `osaa.his.observability.configure` | `cluster-manager-his-owner-facade` | `critical` | `required` |
