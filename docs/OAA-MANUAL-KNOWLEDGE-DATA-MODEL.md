...
| Read/plan Shared Observability configuration | `oaa.platform.support.observability.config` / `oaa.platform.support.observability.plan` | `cluster-manager-platform-support-owner-facade` | `read` | `none` |
| Validate/manage Shared Observability lifecycle | `oaa.platform.support.observability.validate` / `oaa.platform.support.observability.lifecycle` | `cluster-manager-platform-support-owner-facade` | `high/critical` | `required` |
| Apply Shared Observability configuration | `oaa.platform.support.observability.configure` | `cluster-manager-platform-support-owner-facade` | `critical` | `required` |
