...
> **상태**: 구현·운영 정본 · **작성일**: 2026-06-29 · **승격일**: 2026-07-11 · **대상 독자**: 콘솔/플랫폼 팀
...
>
> **필수 계층**: `Backbone → Main Shell/Console 기능 → subShell → plugin`. Backbone은 Console 내부에서 선택 설치하는 기능이 아니며, 세 기둥이 준비되지 않은 Console은 `Not Ready`다.
...
| 컴포넌트 | 역할 | 이미지(핀) |
|---|---|---|
| **PostgreSQL + pgvector** | 콘솔 앱 DB(append-only 감사로그·사용자 설정·플러그인 메타) + Gitea DB 호스팅 | `opensphere-backbone-postgres@sha256:76470c…` |
