...
var commandHelp = map[string]string{
	...
	"config":        "os config — 비밀이 아닌 로컬 CLI 설정을 조회하거나 변경합니다.\n사용법: os config get [key] | set <key> <value> | list | profiles | use-profile <name>\n하위명령: get, set, list, profiles, use-profile\n플래그: --profile NAME\n예: os config get consoleUrl\n    os config --profile staging set consoleUrl https://console.example.com\n    os config use-profile staging\n",
	"completion":    "os completion — 셸 자동완성 스크립트를 출력합니다.\n사용법: os completion bash|zsh|powershell\n하위명령: bash, zsh, powershell\n플래그: 없음\n예: os completion bash\n    os completion powershell\n",
}
