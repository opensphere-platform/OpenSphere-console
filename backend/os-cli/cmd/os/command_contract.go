...
var commandDefinitions = []commandDefinition{
	...
	{Name: "extensions", Summary: "확장 패키지와 Binding 관리", Usage: []string{"os extensions inspect|install|activate|disable|uninstall|rollback|list ...", "os extensions bindings list|enable|disable ...", "os extensions registry status|login|logout ...", "os extensions revocations|revoke-image ..."}, Options: []string{"--reason TEXT", "--username NAME", "--token-stdin", "--replacement IMAGE"}},
