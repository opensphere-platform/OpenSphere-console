...
- 인증: Kanidm/BFF 장치 승인(P-256) + 15분 CLI 세션. 자동화 API 토큰은 비대화형 작업 전용
...
```bash
docker build --build-context macos-cli=/absolute/path/to/opensphere-cli-macos -t os-cli:console-native-v0.4.0 backend/os-cli
```
