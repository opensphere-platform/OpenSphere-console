...
const documents = [
  ...
  doc({
    ...
    title: 'OAA Control Plane Implementation and Assessment',
    version: '2026-07-23',
    path: 'OpenSphere-console/docs/OAA-CONTROL-PLANE-ASSESSMENT-2026-07-23.md',
    documentType: 'architecture',
    authorityTier: 3,
    perspective: ['main-shell', 'ai-level', 'k8s-cluster-ceph'],
    plane: ['p1-control', 'p4-intelligence', 'p6-experience'],
    component: ['oaa-gateway', 'supabase', 'gitea', 'oaa-governed-adapter'],
    tags: ['oaa', 'agent', 'runtime-watch', 'governed-control', 'supabase'],
  }),
  doc({
