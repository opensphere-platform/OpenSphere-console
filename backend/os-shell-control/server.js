...
const { createOsShellDatabase } = require('../opensphere-console-backend/os-shell-database');
const { createAttachTicket, hashAttachTicket, normalizeSessionIntent } = require('../opensphere-console-backend/os-shell-contract');
const { verifyOsShellAdmission } = require('../opensphere-console-backend/os-shell-admission');
