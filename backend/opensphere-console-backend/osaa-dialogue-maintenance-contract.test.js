...
const conversationStore = readFileSync(join(__dirname, '..', 'opensphere-osdst', 'conversation-store.js'), 'utf8');
const osdstSource = readFileSync(join(__dirname, '..', 'opensphere-osdst', 'server.js'), 'utf8');
const osdstDeploy = readFileSync(join(__dirname, '..', 'opensphere-osdst', 'deploy.yaml'), 'utf8');
