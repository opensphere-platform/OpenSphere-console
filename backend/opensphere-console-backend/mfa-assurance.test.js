...
const authService = fs.readFileSync(path.join(root, 'apps/console-web/src/app/core/auth.service.ts'), 'utf8');
const httpService = fs.readFileSync(path.join(root, 'apps/console-web/src/app/core/http.service.ts'), 'utf8');
const browserSession = fs.readFileSync(path.join(__dirname, 'browser-session.js'), 'utf8');
const login = fs.readFileSync(path.join(root, 'apps/console-web/src/app/pages/login.ts'), 'utf8');
const nginx = fs.readFileSync(path.join(root, 'apps/console-web/nginx/default.conf.template'), 'utf8');
const setup = fs.readFileSync(path.join(root, 'apps/console-web/src/app/pages/initial-setup.ts'), 'utf8');
const myInfo = fs.readFileSync(path.join(root, 'apps/console-web/src/app/pages/my-info.ts'), 'utf8');
const osShell = fs.readFileSync(path.join(root, 'apps/console-web/src/app/os/os-shell.ts'), 'utf8');
const profileAvatar = fs.readFileSync(path.join(__dirname, 'profile-avatar.js'), 'utf8');
const consoleAdmins = fs.readFileSync(path.join(root, 'apps/console-web/src/app/pages/console-admins.ts'), 'utf8');
const recoveryPage = fs.readFileSync(path.join(root, 'apps/console-web/src/app/pages/password-recovery.ts'), 'utf8');
const app = fs.readFileSync(path.join(root, 'apps/console-web/src/app/app.ts'), 'utf8');
const routes = fs.readFileSync(path.join(root, 'apps/console-web/src/app/app.routes.ts'), 'utf8');
