...
assert.match(installer, /Set-WorkloadStartupProbe 'deployment\/opensphere-supabase-auth' 'auth'/);
assert.match(installer, /Set-WorkloadStartupProbe 'deployment\/opensphere-supabase-rest' 'rest'/);
