...
DROP POLICY IF EXISTS console_backend_notification_event ON console.notification_event;
DROP POLICY IF EXISTS console_backend_notification_delivery ON console.notification_delivery;
DROP POLICY IF EXISTS console_backend_notification_attempt ON console.notification_attempt;
DROP POLICY IF EXISTS console_backend_notification_callback ON console.notification_callback_receipt;
DROP POLICY IF EXISTS console_backend_notification_control ON console.notification_delivery_control;
DROP POLICY IF EXISTS dispatcher_notification_channel ON console.notification_channel;
DROP POLICY IF EXISTS dispatcher_notification_channel_update ON console.notification_channel;
DROP POLICY IF EXISTS dispatcher_notification_rule ON console.notification_rule;
DROP POLICY IF EXISTS dispatcher_notification_rule_channel ON console.notification_rule_channel;
DROP POLICY IF EXISTS dispatcher_notification_event_select ON console.notification_event;
DROP POLICY IF EXISTS dispatcher_notification_event_update ON console.notification_event;
DROP POLICY IF EXISTS dispatcher_notification_delivery_select ON console.notification_delivery;
DROP POLICY IF EXISTS dispatcher_notification_delivery_insert ON console.notification_delivery;
DROP POLICY IF EXISTS dispatcher_notification_delivery_update ON console.notification_delivery;
DROP POLICY IF EXISTS dispatcher_notification_attempt_select ON console.notification_attempt;
DROP POLICY IF EXISTS dispatcher_notification_attempt_insert ON console.notification_attempt;
DROP POLICY IF EXISTS dispatcher_notification_callback_select ON console.notification_callback_receipt;
DROP POLICY IF EXISTS dispatcher_notification_callback_insert ON console.notification_callback_receipt;
DROP POLICY IF EXISTS dispatcher_notification_control ON console.notification_delivery_control;
