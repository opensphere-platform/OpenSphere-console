...
const SECRET = process.argv[2] || 'CPBOZXXJSAJZGKG7MS3LK4VEPSMDNJ6RIILVWP62QLHJPBQJSM6A';
...
(async () => {
  ...
  const aform = new URLSearchParams({ client_id: 'opensphere-console', redirect_uri: 'http://localhost:8090/', response_type: 'code', scope: 'openid profile email groups_name', state, code_challenge: challenge, code_challenge_method: 'S256', username: 'tester', password: 'Sphere9-Vt7q-Live-Pw', totp: totp() }).toString();
