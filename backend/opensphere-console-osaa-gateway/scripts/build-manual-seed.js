...
const documents = [
  ...
  doc({
    ...
    title: 'CONSTITUTION-0002 OpenSphere Registry',
    path: '_DOCS_/01-CONSTITUTION/CONSTITUTION-0002-레지스트리.md',
    documentType: 'policy',
    authorityTier: 0,
    perspective: ['main-shell', 'developer', 'api-information-flow'],
    plane: ['p1-control', 'p5-catalog-store', 'p6-experience'],
    component: ['registry', 'catalog', 'shared-object-graph'],
    tags: ['constitution', 'registry', 'catalog', 'declarative-write'],
  }),
  doc({
    sourceId: 'opensphere-docs/constitution-0003-shell-hosting',
    title: 'CONSTITUTION-0003 Shell Hosting Integration',
    path: '_DOCS_/01-CONSTITUTION/CONSTITUTION-0003-SHELL-HOSTING-INTEGRATION.md',
    documentType: 'policy',
    authorityTier: 0,
    perspective: ['main-shell'],
    plane: ['p1-control', 'p6-experience'],
    component: ['main-shell', 'subshell', 'extension-host', 'consumer-lifecycle'],
    tags: ['constitution', 'shell-hosting', 'extension', 'lifecycle'],
  }),
  doc({
  ...
  doc({
    ...
    component: ['supabase', 'gitea', 'observability-binding', 'osaa-gateway'],
    tags: ['platform-control-plane', 'supabase', 'gitea', 'his-binding', 'osaa'],
  }),
  doc({
    sourceId: 'console-docs/osaa-control-plane-assessment',
    title: 'OSAA Control Plane Implementation and Assessment',
    version: '2026-07-23',
    path: 'OpenSphere-console/docs/OSAA-CONTROL-PLANE-ASSESSMENT-2026-07-23.md',
    documentType: 'architecture',
    authorityTier: 3,
    perspective: ['main-shell', 'ai-level', 'k8s-cluster-ceph'],
    plane: ['p1-control', 'p4-intelligence', 'p6-experience'],
    component: ['osaa-gateway', 'supabase', 'gitea', 'osaa-governed-adapter'],
    tags: ['osaa', 'agent', 'runtime-watch', 'governed-control', 'supabase'],
  }),
  doc({
    sourceId: 'console-docs/osaa-manual-knowledge-data-model',
    title: 'OSAA Manual Knowledge Data Model',
    path: 'OpenSphere-console/docs/OSAA-MANUAL-KNOWLEDGE-DATA-MODEL.md',
    documentType: 'reference',
    authorityTier: 3,
    perspective: ['ai-level'],
    plane: ['p4-intelligence', 'p6-experience'],
    component: ['osaa', 'manual', 'knowledge'],
    tags: ['osaa', 'manual', 'knowledge-model'],
  }),
  doc({
