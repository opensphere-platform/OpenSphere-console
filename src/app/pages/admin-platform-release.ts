      ...
      <div class="workspace">
        <section class="request-card">
          ...
          <div class="form-grid">
            ...
            <label>Target Release Lock JSON
              <textarea clrTextarea rows="15" [(ngModel)]="releaseText" (ngModelChange)="parseRelease()" placeholder="opensphere-setup resolve이 생성한 OpenSphereReleaseLock JSON을 붙여 넣으세요."></textarea>
            </label>
          </div>
          ...
          @if (target(); as targetLock) {
            <dl class="target-summary">
              ...
              <div><dt>Components</dt><dd>{{ componentNames(targetLock).length }}</dd></div>
            </dl>
