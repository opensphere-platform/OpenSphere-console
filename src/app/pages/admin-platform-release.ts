        ...
        <section class="request-card">
          ...
          <div class="form-grid">
            ...
            <label class="release-json-field">전체 Target Release Lock JSON · 통합 release 또는 과거 rollback
              <textarea class="release-json-editor" clrTextarea rows="12" [(ngModel)]="releaseText" (ngModelChange)="parseRelease()" placeholder="통합 OpenSphereReleaseLock을 붙여 넣거나 위에서 Component Lock을 생성하세요."></textarea>
            </label>
          </div>
