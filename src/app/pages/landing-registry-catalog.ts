...
@Component({
  ...
  styles: [`
    ...
    .scope-panel,.descriptor-model{padding:1.3rem;border:1px solid var(--os-hairline);background:var(--os-canvas)}.scope-panel>header,.descriptor-model>header{margin-bottom:1rem}.scope-panel h2,.descriptor-model h2,.coverage-panel h2{margin:.3rem 0;font-size:1.15rem;line-height:1.35}.scope-panel header>p:last-child,.descriptor-model header>p:last-child,.coverage-panel>div>p:last-child{max-width:74rem;margin:.45rem 0 0;color:var(--os-ink-muted);font-size:var(--detail);line-height:1.55}
    ...
    .coverage-panel{display:grid;grid-template-columns:minmax(18rem,.7fr) minmax(0,1.3fr);gap:1.25rem;padding:1.3rem;border-inline-start:4px solid var(--os-accent);background:var(--os-surface-1)}.coverage-panel dl{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin:0;border:1px solid var(--os-hairline);background:var(--os-canvas)}.coverage-panel dl>div{padding:1rem;border-inline-end:1px solid var(--os-hairline)}.coverage-panel dl>div:last-child{border-inline-end:0}.coverage-panel dt{color:var(--os-accent);font-size:.72rem;font-weight:700}.coverage-panel dd{margin:.4rem 0 0;color:var(--os-ink-muted);font-size:var(--detail);line-height:1.5}
