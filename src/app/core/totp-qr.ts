 ...
 * versions. v2.189.0 prefixes that SVG with an XML declaration and an SVGo
 * generator comment, while SDK-shaped responses may already contain an image
 * data URL. Angular's img binding needs a URL, so encode the complete raw SVG
 * without interpreting it as DOM and reject every unrelated URL scheme.
 */
