...
export class SearchService {
  ...
  private readonly DOCS: SearchResult[] = [
    ...
    { label: 'Modules & Extensions 관리', sublabel: 'Console', path: '/manage/extensions', kind: 'result' },
    { label: 'CBSS 자원 서비스', sublabel: 'Supabase · Gitea · Beszel · Live evidence', path: '/manage/foundation-services', kind: 'result' },
  ...
  private readonly STATIC: SearchResult[] = [
    ...
    { label: 'Modules & Extensions', sublabel: '관리 · 자산 및 확장', path: '/manage/extensions', kind: 'page' },
    { label: 'CBSS 자원 서비스', sublabel: '관리 · Console Backbone resources', path: '/manage/foundation-services', kind: 'page' },
