...
@Component({
  ...
  styles: [`
    ...
    .workspace-tabs button:focus-visible,a:focus-visible{outline:2px solid var(--os-accent);outline-offset:3px}.panel{margin:.8rem 0;padding:1rem;border:1px solid var(--os-hairline);background:var(--os-canvas)}h2{font-size:1rem;margin:0 0 .6rem}h3{font-size:.8rem}.muted,.help{color:var(--os-ink-muted);font-size:.72rem}.actions{display:flex;flex-wrap:wrap;gap:.6rem 1rem;margin:.7rem 0}.actions a{font-size:.72rem}.notice{padding:.7rem 1rem;margin:.7rem 0;border-left:3px solid #a15c00;background:var(--os-surface-1);font-size:.75rem}.status{font-size:.68rem;font-weight:600;white-space:nowrap}.ok{color:var(--os-success)}.warn{color:#8a5000}.danger{color:var(--os-danger)}.scroll{overflow-x:auto}table{width:100%;border-collapse:collapse;font-size:.72rem;text-align:left}caption{text-align:left;font-size:.8rem;font-weight:600;margin:.5rem 0}th,td{border-bottom:1px solid var(--os-hairline);padding:.55rem .65rem;vertical-align:top}th{background:var(--os-surface-1);font-size:.65rem}td small{display:block;color:var(--os-ink-muted);font-size:.63rem;margin-top:.25rem}.mono{font-family: var(--os-font-mono);overflow-wrap:anywhere;font-size:.68rem}dl{display:grid;grid-template-columns:9rem minmax(0,1fr);gap:.45rem;margin:.5rem 0}dt{color:var(--os-ink-muted);font-size:.7rem}dd{margin:0;font-size:.73rem}.two{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.8rem}.domains{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.6rem}.domains .panel{margin:0}.empty{padding:1rem;color:var(--os-ink-muted)}.checks{min-width:45rem}.state-note{font-size:.65rem;margin:.25rem 0}
