  ...
  RETURN jsonb_build_object(
    ...
    'data', jsonb_build_object(
      ...
      'components', jsonb_build_array(
        ...
        jsonb_build_object(
          'component', 'rls',
          'state', CASE WHEN v_authority_table_count = 15 AND v_rls_table_count = v_authority_table_count THEN 'Ready' ELSE 'Blocked' END,
          'authority', 'PostgreSQLCatalog',
          'reasonCode', CASE WHEN v_authority_table_count = 15 AND v_rls_table_count = v_authority_table_count THEN NULL ELSE 'RlsCoverageIncomplete' END,
